...
class Graph extends React.Component<{ engine: SRD.DiagramEngine }> {
    ...
    public constructor(props: any) {
        ...
        const zoom = this.props.engine.getDiagramModel().getZoomLevel() / 100 * 60;
    ...
    public render() {
        return (
            <SRD.DiagramWidget
                ...
                className="graph"
                inverseZoom={true}
                extraProps={{style: {backgroundSize: this.state.size, backgroundPosition: this.state.position}}}
            />
        );
    }
}
