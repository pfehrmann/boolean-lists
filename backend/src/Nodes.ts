...
export abstract class PlaylistNode implements Observable {
    ...
    public static fromJSON(json: { type: string }): Promise<PlaylistNode> {
        switch (json.type) {
            ...
            case LimitNode.type: {
                return LimitNode.fromJSON(json);
            }
            case RandomizeNode.type: {
                return RandomizeNode.fromJSON(json);
            }
        }
...
export class LimitNode extends IntermediatePlaylist {
    ...
    static async fromJSON(json: any): Promise<LimitNode> {
        let inPlaylist = PlaylistNode.fromJSON(json.inPlaylist);
...
export class RandomizeNode extends IntermediatePlaylist {
    ...
    static async fromJSON(json: any): Promise<RandomizeNode> {
        let inPlaylist = PlaylistNode.fromJSON(json.inPlaylist);
